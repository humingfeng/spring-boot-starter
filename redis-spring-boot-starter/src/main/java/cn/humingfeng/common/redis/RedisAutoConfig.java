package cn.humingfeng.common.redis;

import cn.humingfeng.common.redis.serializer.RedisObjectSerializer;
import cn.humingfeng.common.redis.util.RedisUtil;
...
/**
 * @author humingfeng
 * @version 创建时间：2020年06月23日 下午20:01:06 类说明 redis自动装配
 */
@Configuration
...
public class RedisAutoConfig {
    ...
    public LettuceConnectionFactory lettuceConnectionFactory(GenericObjectPoolConfig genericObjectPoolConfig) {
        ...
        if (redisProperties.getSentinel() != null) {
            ...
            ((RedisSentinelConfiguration) redisConfiguration).setPassword(RedisPassword.of(redisProperties.getPassword()));
            ...
            ((RedisStandaloneConfiguration) redisConfiguration).setPassword(RedisPassword.of(redisProperties.getPassword()));
